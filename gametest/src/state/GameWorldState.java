...
public class GameWorldState extends State {
    ...
    public GameWorldState(GamePanel gamePanel){
		...
		player = new Player(500, 500, this);stateManager.getPlayerImage();
...
//                g2.drawString("All monster have been slain, mission completed!", 100, 300);
            ...
            case GAMEPLAY:
                ...
                synchronized(particularObjectManager.particularObjects){
                    for(int id = 0; id < particularObjectManager.particularObjects.size(); id++){
                        ParticularObject object = particularObjectManager.particularObjects.get(id);
